...
class IntegromatMetadata(metadata.BaseMetadata):
...
class IntegromatFileMetadataHeaders(IntegromatMetadata, metadata.BaseFileMetadata):
...
class IntegromatFileMetadata(IntegromatMetadata, metadata.BaseFileMetadata):
...
class IntegromatFolderKeyMetadata(IntegromatMetadata, metadata.BaseFolderMetadata):
...
class IntegromatFolderMetadata(IntegromatMetadata, metadata.BaseFolderMetadata):
...
class IntegromatRevision(metadata.BaseFileRevisionMetadata):
